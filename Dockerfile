...
LABEL version="0.8"
LABEL description="This is an image for the IPM Decisions DWD weather adapter for MeteoFrance"
...
RUN apt-get update
RUN apt-get install --assume-yes software-properties-common apt-utils cron libfile-copy-recursive-perl libdatetime-format-dateparse-perl apache2 libapache2-mod-wsgi-py3 python3-pip git curl
